...
//允许动作
$dos = array('feed', 'doing', 'mood', 'blog', 'repaste', 'album', 'thread', 'mtag', 'friend', 'wall', 'tag', 'notice', 'share', 'report', 'topic', 'topicalbum', 'cover', 'video', 'tone', 'home', 'pm', 'event', 'poll', 'top', 'info', 'resume', 'videophoto', 'sitegift', 'postnote', 'radio', 'forum', 'wiki', 'myfarm');
