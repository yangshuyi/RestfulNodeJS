...
$qsql="SELECT * FROM ".tname('resume')." WHERE uid='$space[uid]'";
...
if( !empty($value) ) {
	...
	$task['done'] = 1;//任务完成
	$task['result'] .= '<p>您已完成设置自己的介绍，这有助于其他人找寻到您。</p>';
	
} else {

	$task['guide'] .= '<strong>请按照以下的说明来完成本任务：</strong>
		<ul class="task">
		<li>请设置您的<a href="cp.php?ac=resume&op=maintain" target="_blank">自我介绍</a>；</li>
		</ul>';
}
