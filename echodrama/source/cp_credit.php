...
if(empty($_GET['op'])) {
	$nav_item = array();
	$nav_item['url'] = "cp.php?ac=credit"; $nav_item['dispname'] = "我的积分";
	$nav_list[] = $nav_item;
}
elseif ($_GET['op'] == 'rule') {
	$nav_item = array();
	$nav_item['url'] = "cp.php?ac=credit&op=rule"; $nav_item['dispname'] = "积分规则";
	$nav_list[] = $nav_item;	
}
elseif ($_GET['op'] == 'usergroup') {
	$nav_item = array();
	$nav_item['url'] = "cp.php?ac=credit&op=usergroup"; $nav_item['dispname'] = "用户组规则";
	$nav_list[] = $nav_item;	
}
