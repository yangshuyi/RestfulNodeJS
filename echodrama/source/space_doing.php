...
if($_GET['view'] == 'all') {
	$nav_item = array();
	$nav_item['url'] = "space.php?do=$do&uid=$space[uid]&view=all"; $nav_item['dispname'] = "大家的记录";
	$nav_list[] = $nav_item;
} 
elseif( $_GET['view'] == 'me') {
	$nav_item = array();
	$nav_item['url'] = "space.php?do=$do&uid=$space[uid]&view=me"; $nav_item['dispname'] = "我的记录";
	$nav_list[] = $nav_item;
} 
else {
	$nav_item = array();
	$nav_item['url'] = "space.php?do=$do&uid=$space[uid]&view=we"; $nav_item['dispname'] = "最新好友的记录";
	$nav_list[] = $nav_item;
}
