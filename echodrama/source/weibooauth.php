...
{ 
     ...
     *  
     * @access public 
     * @param mixed $akey 寰崥寮�斁骞冲彴搴旂敤APP KEY 
     * @param mixed $skey 寰崥寮�斁骞冲彴搴旂敤APP SECRET 
     ...
     *  
     * @access public 
     * @param int $page 杩斿洖缁撴灉鐨勯〉搴忓彿銆�
     * @param int $count 姣忔杩斿洖鐨勬渶澶ц褰曟暟锛堝嵆椤甸潰澶у皬锛夛紝涓嶅ぇ浜�00锛岄粯璁や负20銆�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $text 瑕佹洿鏂扮殑寰崥淇℃伅銆�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param string $text 瑕佹洿鏂扮殑寰崥淇℃伅銆�
     * @param string $text 瑕佸彂甯冪殑鍥剧墖璺緞,鏀寔url銆俒鍙敮鎸乸ng/jpg/gif涓夌鏍煎紡,澧炲姞鏍煎紡璇蜂慨鏀筭et_image_mime鏂规硶] 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $sid 瑕佽幏鍙栧凡鍙戣〃鐨勫井鍗欼D 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 鐢ㄦ埛UID鎴栧井鍗氭樀绉般� 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param bool $cursor 鍗曢〉鍙兘鍖呭惈100涓叧娉ㄥ垪琛紝涓轰簡鑾峰彇鏇村鍒檆ursor榛樿浠�1寮�锛岄�杩囧鍔犳垨鍑忓皯cursor鏉ヨ幏鍙栨洿澶氱殑鍏虫敞鍒楄〃 
     * @param bool $count 姣忔杩斿洖鐨勬渶澶ц褰曟暟锛堝嵆椤甸潰澶у皬锛夛紝涓嶅ぇ浜�00,榛樿杩斿洖20 
     * @param mixed $uid_or_name 瑕佽幏鍙栫殑 UID鎴栧井鍗氭樀绉�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param bool $cursor 鍗曢〉鍙兘鍖呭惈100涓矇涓濆垪琛紝涓轰簡鑾峰彇鏇村鍒檆ursor榛樿浠�1寮�锛岄�杩囧鍔犳垨鍑忓皯cursor鏉ヨ幏鍙栨洿澶氱殑绮変笣鍒楄〃 
     * @param bool $count 姣忔杩斿洖鐨勬渶澶ц褰曟暟锛堝嵆椤甸潰澶у皬锛夛紝涓嶅ぇ浜�00,榛樿杩斿洖20銆�
     * @param mixed $uid_or_name  瑕佽幏鍙栫殑 UID鎴栧井鍗氭樀绉�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 瑕佸叧娉ㄧ殑鐢ㄦ埛UID鎴栧井鍗氭樀绉�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 瑕佸彇娑堝叧娉ㄧ殑鐢ㄦ埛UID鎴栧井鍗氭樀绉�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 瑕佸垽鏂殑鐢ㄦ埛UID 
     * @return array 
     */ 
     ...
     * @access public 
     * @param int $page 椤电爜 
     * @param int $count 姣忔杩斿洖鐨勬渶澶ц褰曟暟锛屾渶澶氳繑鍥�00鏉★紝榛樿20銆�
     * @param mixed $uid_or_name 鎸囧畾鐢ㄦ埛UID鎴栧井鍗氭樀绉�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name UID鎴栧井鍗氭樀绉�
     * @param mixed $text 瑕佸彂鐢熺殑娑堟伅鍐呭锛屾枃鏈ぇ灏忓繀椤诲皬浜�00涓眽瀛椼� 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $did 瑕佸垹闄ょ殑绉佷俊涓婚敭ID 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $sid 杞彂鐨勫井鍗欼D 
     * @param bool $text 娣诲姞鐨勮浆鍙戜俊鎭� 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $sid 瑕佽瘎璁虹殑寰崥id 
     * @param mixed $text 璇勮鍐呭 
     * @param bool $cid 瑕佽瘎璁虹殑璇勮id 
     * @return array 
     */ 
    ...
    /** 
     * 鎵归噺缁熻寰崥鐨勮瘎璁烘暟锛岃浆鍙戞暟锛屼竴娆¤姹傛渶澶氳幏鍙�00涓� 
     *  
     * @access public 
     * @param mixed $sids 寰崥ID鍙峰垪琛紝鐢ㄩ�鍙烽殧寮�
     * @return array 
     */ 
    ...
    /** 
     * 瀵逛竴鏉″井鍗氳瘎璁轰俊鎭繘琛屽洖澶嶃� 
     *  
     * @access public 
     * @param mixed $sid 寰崥id 
     * @param mixed $text 璇勮鍐呭銆�
     * @param mixed $cid 璇勮id 
     * @return array 
     */ 
    ...
    /** 
     * 杩斿洖鐢ㄦ埛鐨勫彂甯冪殑鏈�繎20鏉℃敹钘忎俊鎭紝鍜岀敤鎴锋敹钘忛〉闈㈣繑鍥炲唴瀹规槸涓�嚧鐨勩� 
     *  
     * @access public 
     * @param bool $page 杩斿洖缁撴灉鐨勯〉搴忓彿銆�
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $sid 瑕佸垹闄ょ殑鏀惰棌寰崥淇℃伅ID. 
     * @return array 
     */ 
