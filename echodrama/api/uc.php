...
class uc_note {
	...
	function renameuser($get, $post) {
		...
		$_SGLOBAL['db']->query("UPDATE ".tname('mtag_thread')." SET username='$new_username' WHERE username='$old_username'");
		$_SGLOBAL['db']->query("UPDATE ".tname('mtagmember')." SET username='$new_username' WHERE username='$old_username'");
