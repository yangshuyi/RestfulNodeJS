...
$_SGLOBAL['msglang'] = array(
	...
	'no_privilege_realname' => '您需要填写社团成员名后才能进行当前操作，<a href="cp.php?ac=profile">点这里设置社团成员名</a>',
	...
	'no_authority_to_add_log' => '您目前没有权限添加日记',
	'no_authority_operation_of_the_log' => '您没有权限操作该日记',
	...
	'no_authority_to_add_repaste' => '您目前没有权限添加转帖',
	'no_authority_operation_of_the_log' => '您没有权限操作该转帖',
	...
	'do_not_accept_comments' => '该日记不接受评论',
	...
	'choose_at_least_one_log' => '请至少选择一个要导入的日记',
	...
	'realname_too_short' => '社团成员名不能少于4个字符',
	...
	//source/cp_share.php
	'blog_does_not_exist' => '指定的日记不存在',
	'logs_can_not_share' => '指定的日记因隐私设置不能够被分享',
	...
	'share_already' => '你已经分享了该作品',
	'share_message_limit' => '分享说明需大于50个字符',
	...
	'topic_does_not_exist' => '指定的广播剧不存在',
	'topicforecast_does_not_exist' => '指定的广播剧预告不存在',
	'topic_threadid_does_not_exist' => '指定的广播剧还未关联至论坛',
	'topic_quickcomment_author_empty' => '用户名/马甲名不能为空',
	'topic_quickcomment_message_empty' => '快评内容不能为空',
	...
	'gift_unavailable' => '这个奖品设置已经取消了。',
	'gift_maxnum' => '这个奖品已经被其他人抢光了,以后赶早吧～～～',
	...
	'report_does_not_exist' => '该投诉不存在或已被删除',
	'report_process_state_error' => '该投诉状态不存在',
	'report_process_state_check_error' => '您无权调整该投诉状态',
	...
	//source/cp_event.php
	'event_title_empty'=>'招募名称不能为空',
	'event_typeid_empty'=>'必须选择招募活动类型',
	'event_classid_empty'=>'必须选择招募人员类型',
	'event_location_empty'=>'必须选择活动地点',
	'event_city_empty'=>'必须选择招募活动城市',
	'event_detail_empty'=>'必须填写招募活动介绍',
	'event_bad_time_range'=>'招募活动持续时间不能超过60天',
	'event_bad_endtime'=>'招募活动结束时间不能早于开始时间',
	'event_bad_deadline'=>'招募活动报名截止时间不能晚于招募活动结束时间',
	'event_bad_starttime'=>'招募活动开始时间不能早于现在',
	'event_already_full'=>'此招募活动参与人数已满',
	'event_will_full' => '人数将超过招募活动参与人数限制',
	'no_privilege_add_event'=>'您没有权限发起新招募',
	'no_privilege_edit_event'=>'您没有权限编辑这个招募活动的信息',
	'no_privilege_manage_event_members' =>'您没有权限管理这个招募活动的成员',
	'no_privilege_manage_event_comment' => '您没有权限管理这个招募活动的评论',
	'no_privilege_manage_event_pic' => '您没有权限管理这个招募活动的相册',
	'no_privilege_do_eventinvite' =>'您没有权限发送招募活动邀请',
	'event_does_not_exist'=>'招募活动不存在或已被删除',
	'event_create_failed'=>'创建招募活动失败，请检查您的输入信息',
	'event_need_verify'=>'招募活动创建成功，等待管理员审核',
	'upload_photo_failed'=>'上传招募活动海报失败',
	'choose_right_eventmember'=>'请选择合适的招募活动成员进行操作',
	'choose_event_pic'=>'请选择招募活动照片',
	'only_creator_can_set_admin'=>'只有创建者可以设置其他组织者',
	'event_not_set_verify'=>'招募活动不需要审核',
	'event_join_limit'=>'此招募活动只有通过邀请才能加入',
	'cannot_quit_event'=>'您不能退出招募活动，因为您还没有加入招募活动或者您是这个招募活动的发起人',
	'event_not_public'=>'这是一个非公开招募活动，只有通过邀请才能查看',
	'no_privilege_do_event_invite' => '此招募活动不允用户邀请好友',
	'event_under_verify' => '此招募活动正在审核中',
	'cityevent_under_condition' => '要浏览同城招募活动，需要先设置您的居住地',
	'event_is_over' => '此招募活动已经结束',
	'event_meet_deadline'=>'招募活动已经截止报名',
	'bad_userevent_status'=>'请选择正确的招募活动成员状态',
	'event_has_followed'=>'您已经关注了此招募活动',
	'event_has_joint'=>'您已经加入了此招募活动',
	'event_is_closed'=>'招募活动已经关闭',
	'event_only_allows_members_to_comment'=>'此招募只允许招募活动成员发表留言',
	'event_only_allows_admins_to_upload'=>'此招募只有组织者可以上传照片',
	'event_only_allows_members_to_upload'=>'只有已加入成员可以上传招募照片',
	'eventinvite_does_not_exist'=>'您没有该招募的招募活动邀请',
	'event_can_not_be_opened' => '此招募活动现在不能被开启',
	'event_can_not_be_closed' => '此招募活动现在不能被关闭',
	'event_only_allows_member_thread' => '只有已加入成员才能发表或回复招募话题',
	'event_mtag_not_match' => '指定群组没有关联到本招募活动',
	'event_memberstatus_limit' => '此招募为私密招募活动，只有已加入成员才能访问',
	'choose_event_thread' => '请选择至少一个招募活动话题进行操作',
	...
	'repaste_does_not_exist'=>'该记录不存在或已被删除',
	'repaste_classid_empty'=>'转帖类型不能为空',
	'repaste_subject_empty'=>'转帖标题不能为空',
	'repaste_message_empty'=>'转帖内容不能为空',
	
	'topic_recommand_does_not_exist'=>'该记录不存在或已被删除',
	'topic_recommand_topic_empty'=>'广播剧ID不能为空',
	'topic_recommand_startdate_empty'=>'广播剧推荐开始时间不能为空',

	'cvweibo_does_not_exist'=>'该记录不存在或已被删除',
	'cvweibo_name_empty'=>'CV名不能为空',
	'cvweibo_weibo_empty'=>'CV微博名不能为空',
	'cvweibo_url_empty'=>'微博地址不能为空',
	'cvweibo_namecheck_ok'=>'该CV名可以使用',
	'cvweibo_namecheck_failure'=>'系统已存在该CV名',


	'topic_album_does_not_exist'=>'该记录不存在或已被删除',
	'topic_album_topic_empty'=>'广播剧ID不能为空',
	'topic_album_startdate_empty'=>'广播剧推荐开始时间不能为空',

	'topic_subject_error' => '标题长度不要少于4个字符',
	'topic_no_found' => '指定要查看的广播剧不存在',
	'topic_does_not_exist'=>'广播剧不存在或已被删除',
	'topic_under_verify' => '此广播剧正在审核中',
	'topic_over_verify' => '此广播剧已被审核',
	'topic_list_none' => '目前还没有可以参与的广播剧',
	'ajax_param' => '\\1,\\2,\\3,\\4,\\5,\\6,\\7,\\8,\\9',

	'topic_uid_empty'=>'发布者ID不能为空',
	'topic_username_empty'=>'发布者人名不能为空',
	'topic_subject_empty'=>'剧名不能为空',
	'topic_message_empty'=>'作品简介不能为空',
	'topic_pic_empty'=>'剧照不能为空',
	'topic_product_empty'=>'作品不能为空',
	'topic_product_exists'=>'指定的作品文件已存在',
	'topic_product_not_exists'=>'作品文件不存在',
	'topic_productclassid_empty'=>'作品类型不能为空',
	'topic_club_empty'=>'所属团队不能为空',
	'topic_director_empty'=>'导演不能为空',
	'topic_writer_empty'=>'编剧不能为空',
	'topic_cast_empty'=>'CAST不能为空',
	'topic_producer_empty'=>'后期制作不能为空',
	'topic_dateline_empty'=>'发布时间不能为空',
	'topic_auditstate_empty'=>'审核通过不能为空',
	'topic_auditdate_empty'=>'审核时间不能为空',
	'topic_auditmessage_empty'=>'审核批注不能为空',
	'topic_thread_not_exists'=>'广播剧关联帖子不存在',
	'topic_post_not_exists'=>'广播剧关联回帖不存在',
	'topic_pic_unmatched'=>'剧照无法对应\\1,\\2',


	'topic_album_subject_empty'=>'专辑名不能为空',
	'topic_album_message_empty'=>'作品简介不能为空',
	'topic_album_pic_empty'=>'剧照不能为空',
	'topic_album_productclassid_empty'=>'作品类型不能为空',
	'topic_album_club_empty'=>'所属团队不能为空',
	'topic_album_director_empty'=>'导演不能为空',
	'topic_album_writer_empty'=>'编剧不能为空',
	'topic_album_cast_empty'=>'CAST不能为空',
	'topic_album_producer_empty'=>'后期制作不能为空',
	'topic_album_dateline_empty'=>'完结时间不能为空',
	
	'topicattachment_does_not_exist'=>'该广播剧资源不存在或已被删除',
	'topicattachment_uid_empty'=>'发布者ID不能为空',
	'topicattachment_username_empty'=>'发布者人名不能为空',
	'topicattachment_subject_empty'=>'资源名称不能为空',
	'topicattachment_message_empty'=>'资源描述不能为空',
	'topicattachment_attachment_empty'=>'资源文件不能为空',
	'topicattachment_productclassid_empty'=>'资源类型不能为空',
	
	'cover_uid_empty'=>'发布者ID不能为空',
	'cover_username_empty'=>'发布者人名不能为空',
	'cover_subject_empty'=>'翻唱作品名不能为空',
	'cover_product_empty'=>'翻唱作品不能为空',
	'cover_message_empty'=>'作品及介绍不能为空',
	'cover_productclassid_empty'=>'作品类型不能为空',
	'cover_club_empty'=>'所属团队不能为空',
	'cover_does_not_exist'=>'该翻唱作品不存在或已被删除',


	'video_uid_empty'=>'发布者ID不能为空',
	'video_username_empty'=>'发布者人名不能为空',
	'video_subject_empty'=>'视频作品名不能为空',
	'video_product_empty'=>'视频作品不能为空',
	'video_message_empty'=>'作品及介绍不能为空',
	'video_productclassid_empty'=>'作品类型不能为空',
	'video_club_empty'=>'所属团队不能为空',
	'video_does_not_exist'=>'该视频作品不存在或已被删除',

	'event_subject_empty'=>'招募名称不能为空',

	'tone_does_not_exist'=>'该声线不存在或已被删除',
	'tone_uid_empty'=>'发布者ID不能为空',
	'tone_username_empty'=>'发布者人名不能为空',
	'tone_label_empty'=>'标签不能为空',
	'tone_description_empty'=>'作品简介不能为空',
	'tone_file_empty'=>'声线作品不能为空',
	'tone_classid_empty'=>'声线类型不能为空',
	'tone_reach_max_size'=>'目前网站只允许用户最多上传10个声线，请展现出您自己最好的作品吧。',
	'tone_file_exists'=>'指定的声线文件已存在',
	'tone_file_empty'=>'声线文件不能为空',
	'tone_file_not_exists'=>'声线文件不存在',
	
	'resume_does_not_exist'=>'该简历信息不存在或已被删除',
	'resume_producttype_empty'=>'作品分类不能为空',
	'resume_uid_empty'=>'发布者ID不能为空',
	'resume_jobid_empty'=>'发布者担任职务不能为空',
	'resume_productname_empty'=>'作品名不能为空',
	'resume_club_empty'=>'所属社团不能为空',
	'resume_introduce_empty'=>'自我介绍不能为空',


	'mtag_name_exist'=>'该群组名称已被使用',
	'mtag_name_empty'=>'群组名称不能为空',
	'mtag_fieldid_empty'=>'群组类型不能为空',
	'mtag_announcement_empty'=>'群组公告不能为空',
	'mtag_dateline_empty'=>'成立时间不能为空',
	'mtag_pic_empty'=>'宣传画不能为空',
	'mtag_fieldid_unidentitied'=>'群组类型无法识别',
	'mtag_not_exist'=>'该群组不存在',
	'mtag_state_not_auditpass'=>'该群组未通过审核',
	'mtag_member_not_exist'=>'该群组成员不存在',
	'mtag_id_empty'=>'群组ID不能为空',
	'mtag_member_realname_empty'=>'成员名不能为空',
	'mtag_memeber_user_does_not_exist' => '该成员还未注册',
	'mtag_member_classid_empty'=>'群组成员职务类型不能为空',
	'mtag_member_gradeid_empty'=>'群组成员权限类型不能为空',
	'mtag_fans_gradeid_empty'=>'粉丝权限类型无法识别',
	'mtag_member_quit_grade_error'=>'群主/副群主不能自己退出群组',
	'mtag_member_gradeid_error'=>'群组成员权限类型错误',
	'mtag_member_creatorid_error'=>'群主必须是注册会员',
	'mtag_member_iscreator_error'=>'群主成员信息不能修改',
	'mtag_product_not_exist'=>'该作品不存在',
	'mtag_product_type_empty'=>'该作品分类不能为空',
	'mtag_product_name_empty'=>'该作品名称不能为空',
	'mtag_task_not_exist'=>'该成员任务不存在',
	'mtag_task_id_empty'=>'该成员任务编号不能为空',
	'mtag_task_classid_empty'=>'该成员任务类型不能为空',
	'mtag_task_subject_empty'=>'该成员任务名称不能为空',
	'mtag_task_name_empty'=>'该成员任务名称不能为空',
	'mtag_task_importance_empty'=>'该成员任务重要级别不能为空',
	'mtag_task_description_empty'=>'该成员任务说明不能为空',
	'mtag_task_nextstep_empty'=>'请选择下步操作',
	'mtag_task_starttime_empty'=>'该任务开始时间不能为空',
	'mtag_task_endtime_empty'=>'该任务结束时间不能为空',
	'mtag_task_starttime_should_before_endtime'=>'开始时间不能晚于结束时间',
	'mtag_injectcredit_lessexperience'=>'你的经验等级还未达到要求（<a href="cp.php?ac=credit&op=usergroup" target="_blank">蚕宝宝级别</a>）,请先努力修炼吧～',
	'mtag_injectcredit_creditinvalid'=>'你的捐助金额必须大于0',
	'mtag_injectcredit_creditrunlow'=>'你的捐助金额超过了你的个人资产',

	'advertisement_not_exist'=>'该站内宣传作品不存在',
	'mtag_credit_not_enough'=>'该群组的资金不足',
	'advertisement_credit_should_larger'=>'你只能增加该站内宣传作品的投入资金',
	'advertisement_credit_empty'=>'该站内宣传作品的投入资金必须大于零',
	'advertisement_weight_empty'=>'该站内宣传作品的展现基数必须大于零',
	'advertisement_credit_empty'=>'该站内宣传作品的投入资金必须大于零',
	'advertisement_location_empty'=>'请选择该站内宣传作品的展现位置',
	'advertisement_description_empty'=>'该站内宣传作品的宣传说明不能为空',
	'advertisement_subject_empty'=>'站内宣传作品名不能为空',
	'advertisement_fromdate_empty'=>'站内宣传作品开始时间不能为空',
	'advertisement_todate_empty'=>'站内宣传作品结束时间不能为空',
	'advertisement_fromdatetodate'=>'站内宣传作品开始时间不能晚于结束时间',

	'advertisement_item_not_exist'=>'该站内宣传作品的指定页签不存在',
	'advertisement_id_empty'=>'该站内宣传作品编号不能为空',
	'advertisement_item_tab_classid_empty'=>'该站内宣传作品页签的类型不能为空',
	'advertisement_item_tab_name_empty'=>'该站内宣传作品页签的显示名称不能为空',
	'advertisement_item_message_empty'=>'该站内宣传作品页签的自定义网页内容不能为空',
	'advertisement_item_pic_empty'=>'该站内宣传作品页签的首页海报不能为空',
	'advertisement_item_video_empty'=>'该站内宣传作品页签的视频链接不能为空',
	'advertisement_item_relatedtopicid_empty'=>'该站内宣传作品页签的广播剧作品关联不能为空',
	'advertisement_item_relatedvideoid_empty'=>'该站内宣传作品页签的视频作品关联不能为空',
	'advertisement_item_relatedmtagid_empty'=>'该站内宣传作品页签的群组作品关联不能为空',
	'advertisement_item_relatedtopicalbumid_empty'=>'该站内宣传作品页签的广播剧专辑关联不能为空',
	'advertisement_itemlist_empty'=>'该站内宣传作品页签数为零',
	'advertisement_item_tab_index_error'=>'该站内宣传作品页签显示位置设定不正确',

	'mtag_thread_not_exist'=>'该话题不存在',
	'username_empty'=>'用户名不能为空',
	'mtag_thread_subject_empty'=>'该话题标题不能为空',
	'mtag_thread_label_empty'=>'请最少设置一个关键字标签',
	'mtag_thread_threadclassid_empty'=>'该话题类型不能为空',
	'mtag_thread_title_empty'=>'该话题标题不能为空',
	'mtag_thread_subject_not_too_little' => '标题不能少于2个字符',
	'posting_does_not_exist' => '指定的话题回复不存在',
	'posting_be_deleted' => '指定的话题回复已被屏蔽',
	'posting_relatedpost_does_not_exist' => '引用的话题回复不存在',
	'posting_relatedpost_be_deleted' => '引用的话题回复已被屏蔽',
	'posting_fakename_empty' => '话题回复马甲名不能为空',
	'choosing_to_operate_the_thread' => '请选择要处理的话题',

	'apply_submit_success' => '申请提交成功，请等待审核。',
	'space_has_been_locked' => '空间已被锁定无法访问，如有疑问请联系管理员',

	'postnote_not_exist'=>'该贴士不存在',
	'postnote_id_empty'=>'该贴士编号不能为空',
	'postnote_uid_empty'=>'贴士被提醒者不能为空',
	'postnote_fromuid_empty'=>'贴士提醒者不能为空',
	'postnote_importance_empty'=>'该贴士重要级别不能为空',
	'postnote_subject_empty'=>'该贴士名称不能为空',
	'postnote_description_empty'=>'该贴士说明不能为空',
	'postnote_notedate_empty'=>'该贴士提醒日期不能为空',
	
	'announcement_does_not_exist'=>'该全站公告不存在',
	'announcement_message_empty'=>'全站公告不能为空',
	'announcement_startdate_empty'=>'开始时间不能为空',

	'radio_does_not_exist' => '指定的电台节目不存在',
	'radio_threadid_does_not_exist' => '指定的电台节目还未关联至论坛',
	'radio_subject_empty'=>'该电台节目名称不能为空',
	'radio_file_empty'=>'该电台节目音频不能为空',
	'radio_starttime_empty'=>'该电台节目开始时间不能为空',
	'radio_endtime_empty'=>'该电台节目结束时间不能为空',


	'site_gift_already_given_out' => '红包已经被领完了',
	'site_got_gift' => '您已经领取到了红包',
	'site_had_got_gift' => '您已经领取过此次红包了',

	'site_gift_unavailable' => '这个红包设置已经取消了。',
	'site_gift_maxnum' => '这个红包已经被其他人抢光了,以后赶早吧～～～',
