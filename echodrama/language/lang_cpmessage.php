...
$_SGLOBAL['cplang'] = array(
	...
	'the_correct_choice_to_delete_the_log' => '请至少正确选择一个要删除的日记',
	...
	'choose_to_delete_the_columns_event'=>'请选择要删除的招募活动',
	'choose_to_grade_the_columns_event'=>'请选择要设置的招募活动状态，新状态不能和原状态相同',
	'have_no_jobclass'=>'删除失败，请保留至少一个职务分类',
	'poster_only_jpg_allowed'=>'由于您的服务器不支持生成缩略图，您在此处只能上传 jpg 格式的图片',
	
	
	//admin/admincp_topic.php
	'choose_to_delete_the_columns_topic'=>'请选择要删除的广播剧',
	'choose_to_audit_the_columns_topic'=>'请选择要审核的广播剧',


	'choose_to_delete_the_columns_tone'=>'请选择要删除的声线',
	'choose_to_rename_the_columns_tone'=>'请选择要重命名的声线'
