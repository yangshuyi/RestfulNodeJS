...
//$_SC['dbuser']  		= 'root'; //用户
//$_SC['dbpw'] 	 		= 'vennise'; //密码
$_SC['dbuser']                = 'upload'; //用户
$_SC['dbpw']                  = 'qqq111```'; //密码
$_SC['dbcharset'] 		= 'gbk'; //字符集
$_SC['pconnect'] 		= 0; //是否持续连接
$_SC['dbname']  		= 'ysys'; //数据库
$_SC['tablepre'] 		= 'ysys_'; //表名前缀
$_SC['charset'] 		= 'gbk'; //页面字符集
$_SC['memcacheSetting'] = '1'; //页面字符集

//CONSOLE DB
$_SC['console_dbhost']  		= 'localhost:3306'; //服务器地址
#$_SC['console_dbuser']  		= 'root'; //用户
#$_SC['console_dbpw'] 	 		= 'vennise'; //密码
$_SC['console_dbuser']                  = 'upload'; //用户
$_SC['console_dbpw']                    = 'qqq111```'; //密码
$_SC['console_dbcharset'] 		= 'gbk'; //字符集
$_SC['console_pconnect'] 		= 0; //是否持续连接
$_SC['console_dbname']  		= 'console'; //数据库
$_SC['console_tablepre'] 		= 'console_'; //表名前缀
...
define('UC_DBHOST', 'localhost:3306'); // UCenter 数据库主机
define('UC_DBUSER', 'upload'); // UCenter 数据库用户名
define('UC_DBPW', 'qqq111```'); // UCenter 数据库密码
define('UC_DBNAME', 'console'); // UCenter 数据库名称
define('UC_DBCHARSET', 'gbk'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`console`.console_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', '5l9ebg1S8wa82U7Oe0c7aM1m8j83fp0PdHai559gfp0f6o196Ce8bDf07Rcg7f82'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
//define('UC_KEY', '293dULUWDf8KBswHZLFBTL3O+nZD6/pl4li6QZZJoAzv2+BnxYnwq9bhII1a0Jd9MHIvu5ktFHKN0D3ZxTzOlwidjmo2RUpfDKG9BdayiFvCLfytZRSvUJl4HBST'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://s-35118.gotocdn.com/console'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
define('UC_CHARSET', 'gbk'); // UCenter 的字符集
define('UC_IP', '125.65.108.224'); // UCenter 的 IP, 当 UC_CONNECT 为非 mysql 方式时, 并且当前应用服务器解析域名有问题时, 请设置此值
